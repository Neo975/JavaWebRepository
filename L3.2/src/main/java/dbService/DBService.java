...
public class DBService {
    ...
    public DBService() {
        ...
        sessionFactory = createSessionFactoryConfiguration(configuration);
    }
...
*/
    ...
    private static SessionFactory createSessionFactoryConfiguration(Configuration configuration) {
